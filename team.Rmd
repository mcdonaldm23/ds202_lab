...
1.
```{r, eval=FALSE}
recent_rating = choco[choco$Review.Date>2011,] #Creating a new list that shows only reviews dates from after 2011.

unique(recent_rating$Company.Location) # NOTICE: how many countries are listed but how many levels are there? #Locations of Companies that have review dates after 2011 without duplicates.

recent_rating$Company.Location = droplevels(recent_rating$Company.Location) #Dropping all the level before 2011.
...
<<<<<<< HEAD
Move the legend so it doesn't block the points
=======
#
>>>>>>> 585b1fd16ce2a81c784b2dab09390549e96f1d28
